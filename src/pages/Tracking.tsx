...
import { Plus, Search, Filter, Loader2, MapPin, Navigation, Eye, FileText } from "lucide-react";
  ...
  return (
    <MainLayout title="Vehicle Tracking">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-lg font-medium">Vehicle Tracking & Reports</h2>
          <p className="text-sm text-gray-500">Track vehicle journeys, monitor fleet activity, and generate reports</p>
        </div>
      ...
      <Tabs defaultValue="tracking" className="space-y-6">
        ...
        <TabsContent value="reports" className="space-y-6">
          <TrackingReports tripRecords={tripRecords} />
        </TabsContent>
      </Tabs>
    </MainLayout>
  );
